  ...
  return (
    <>
      <Route
        ...
        component={() => <Kebab kebab={kebab} onOrder={props.onOrder} />}
      />

      <Route
        path={`${props.match.url}/breads`}
        component={() => (
          <BreadsSelector
            onProceed={(bread) => {
